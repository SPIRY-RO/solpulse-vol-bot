...
const startMessage = `
${c.icons.rocket}${c.icons.chartBars} SolPulse Token Booster${c.icons.chartBars}${c.icons.rocket}
...
${c.icons.chainLink} Contact @SpiryBTC or @dukuweb3 for help and info!
